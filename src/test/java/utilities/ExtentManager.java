...
public class ExtentManager {
	...
	public void init() {
		...
		filePath = ".\\reports\\Herolo Report " + reportDate;
		...
		htmlReporter.config().setDocumentTitle("Automation report on Herolo AutomationPage");
		htmlReporter.config().setReportName("Herolo Automation Test");
